...
_accountSid = '8aaf07086e0115bb016e971e91885aa9'

# 说明：主账号Token，登陆云通讯网站后，可在控制台-应用中看到开发者主账号AUTH TOKEN
_accountToken = '76158301e75f497b9602cc875cb358d8'

# 请使用管理控制台首页的APPID或自己创建应用的APPID
_appId = '8aaf07086e0115bb016e971e91f45ab0'
...
if __name__ == '__main__':
    ...
    result = None
    while True:
        result = ccp.send_template_sms('15958949841', ['123456', 5], "1")
        if result == 0:
            print('短信验证码发送成功！')
            break
