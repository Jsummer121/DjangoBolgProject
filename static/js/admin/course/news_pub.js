$(function () {
    ...
    const CONFIG = {
        ...
        credentials: {
            ak: 'c48a806965d148a29ed5c6373136c260',	 // 填写你的百度云中ak和sk
            sk: 'f56834093eca455282f65efe6d30cac4'    // 在百度vod 安全认证里面
        }
    };
    // 百度云vod域名在多媒体/全局设置/发布设置里面
    let BAIDU_VOD_DOMAIN = 'jm9rpsneaek1ms5sjj0.exp.bcevod.com';	// 百度云VOD域名
    ...
    QINIU.upload({
        "domain": "http://q3s3r0ho6.bkt.clouddn.com/",  // 七牛空间域名
